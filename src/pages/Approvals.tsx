...
const Approvals = () => {
  return (
    <div className="space-y-8">
      ...
      <section
        className="space-y-4 mt-12 animate-fade-in"
              ...
              {pendingApprovals.map((approval, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-sm">
                    {new Date(approval.submitted).toLocaleDateString("pt-BR")}
                  </td>
                  <td className="px-4 py-3 text-sm">
                    <Badge
                      variant="outline"
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Avaliação da qualidade, relevância e contribuição acadêmica do
                evento proposto
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Análise da disponibilidade de espaços, equipamentos e orçamento
                necessários
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Conformidade com as políticas educacionais e valores da
                instituição
              </p>
            </div>
          </div>
