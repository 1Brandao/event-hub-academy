...
const eventTypes = [
  {
    type: "Atividades Institucionais",
...
const sampleEvents = [
  {
    ...
    description:
      "Semana dedicada a palestras e workshops sobre tecnologias emergentes.",
  },
  {
    ...
    description:
      "Aulas complementares para desenvolvimento web com React e Node.js.",
  },
  {
    ...
    budget: "Com orçamento",
    description:
      "Discussões sobre avanços e aplicações de IA no mercado atual.",
  },
];
    ...
    <div className="space-y-8">
      <div className="space-y-4 animate-fade-in">
        ...
        <p className="text-muted-foreground max-w-3xl">
          Crie e gerencie diferentes tipos de Atividades acadêmicos com
          aprovação integrada.
        </p>
      </div>
      ...
      <div
        className="space-y-6 mt-10 animate-fade-in"
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant={
                          event.status === "Aprovado" ? "default" : "secondary"
                        }
                        className={
                    ...
                    <div className="flex flex-wrap gap-2 pt-2">
                      <Badge variant="outline" className="bg-college-blue/10">
                        {event.type}
                      </Badge>
                      <Badge variant="outline" className="bg-college-red/10">
                        {event.budget}
                      </Badge>
                    </div>
                  </div>
      ...
      <Card
        className="border border-border mt-8 animate-fade-in"
        style={{ animationDelay: "1200ms" }}
      >
        <CardHeader>
          <CardTitle>Características dos Atividades</CardTitle>
        </CardHeader>
        <CardContent>
